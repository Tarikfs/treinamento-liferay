...
public class AssignmentUtil {
	 ...
	 * @throws NoSuchAssignmentException if a matching assignment could not be found
	 */
	public static Assignment findByCollection(long groupId)
		throws com.liferay.training.gradebook.exception.
			NoSuchAssignmentException {

		return getPersistence().findByCollection(groupId);
	}
	 ...
	 * @return the matching assignment, or <code>null</code> if a matching assignment could not be found
	 */
	public static Assignment fetchByCollection(long groupId) {
		return getPersistence().fetchByCollection(groupId);
	}
	 ...
	 * @return the matching assignment, or <code>null</code> if a matching assignment could not be found
	 */
	public static Assignment fetchByCollection(
		long groupId, boolean useFinderCache) {

		return getPersistence().fetchByCollection(groupId, useFinderCache);
	}
	 ...
	 * @return the assignment that was removed
	 */
	public static Assignment removeByCollection(long groupId)
		throws com.liferay.training.gradebook.exception.
			NoSuchAssignmentException {

		return getPersistence().removeByCollection(groupId);
	}
	 ...
	 * @return the number of matching assignments
	 */
	public static int countByCollection(long groupId) {
		return getPersistence().countByCollection(groupId);
	}
